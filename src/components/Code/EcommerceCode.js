...
export default function ecommerceCode() {
    const codeString = ` # This code retrieves data from a MySQL database using SQLAlchemy and stores 
 # it in a Pandas DataFrame. It calculates quartiles (percentiles) for the Recency, Frequency, and Monetary 
 # values based on the data in the DataFrame. It assigns customer segments (Low,  Medium, or High) based on 
 # the quartiles to each customer in the DataFrame. It inserts the segmented data back into a MySQL table named "RFM_Segmented."
